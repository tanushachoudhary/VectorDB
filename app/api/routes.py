...
from app.models.schemas import (
    ...
    SearchRequest,
    DocumentUploadResponse, ChunkModel, MetadataModel
)
...
@router.post(
    ...
    responses={
        200: {"description": "Document uploaded and indexed successfully"},
...
async def upload_document(
    ...
    tags: Optional[str] = Form(None, description="Comma-separated tags (e.g., 'invoice,financial')"),
    document_id: Optional[str] = Form(None, description="Custom document ID (auto-generated if not provided)")
):
    """
    ...
    2. Text extracted (OCR/PDF parsing)
    3. Chunked into manageable pieces
    4. Indexed with embeddings
    
    Returns document ID and indexing statistics.
    """
    ...
    try:
        ...
        # Index all chunks
        vector_service.repository.index_chunks(all_chunks)
